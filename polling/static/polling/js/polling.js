...
//        }
 ...
 $(document).on('change','.patients', function(){
            ...
            var id ='#'+currentVal;
            if($(this).is(':checked')){
                selected_patients[currentVal] =  $.parseJSON($(id).val());
                console.log(selected_patients);
            }else{
              delete selected_patients[currentVal];
...
$(document).on('click','.savedata', function(){
      var save_data = [];
      hospitalname_value = $('#id_hospital_name_id').val();

      for (var key in selected_patients) {

            if (selected_patients.hasOwnProperty(key))
                selected_patients[key]['hospital_name_id'] = hospitalname_value;
                save_data.push(selected_patients[key]);
      }
      console.log(save_data);

      create_post(save_data);
...
function create_post(save_data) {
